...
.PHONY: all build build-openclaw-base build-manager build-manager-aliyun build-worker build-copaw-worker build-orchestrator build-docker-proxy \
        tag push push-openclaw-base push-manager push-manager-aliyun push-worker push-copaw-worker push-orchestrator \
