...
def push_local(sync: FileSync, since: float = 0) -> list[str]:
    ...
    Excludes Manager-managed files and runtime/ephemeral directories.
    AGENTS.md, SOUL.md, memory/ are Worker-managed and pushed.
    """
    ...
    # Keep in sync with HICLAW_SYNC_EXCLUDES in hiclaw-env.sh.
    _EXCLUDE_DIRS = {
        ".mc.bin",
        ".mc",
        ".openclaw",
